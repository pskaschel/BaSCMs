...
This article is a methodological and theoretical contribution. All data were simulated from a documented, seeded data-generating process, and no new empirical data were collected. Preregistration and ethics committee approval were therefore not applicable. Generative AI [Claude; @anthropic2026] was used to review the consistency between the analysis script and the manuscript text, to suggest corrections to the analysis code, and for language editing of individual passages, which were subsequently revised by the authors. All model specifications, priors, analyses, and scientific claims were determined by the authors, who take full responsibility for the content. A statement on the use of generative AI, the analysis script, the session information documenting the software environment, and the reproducible manuscript source are provided in the project repository (<https://github.com/pskaschel/BaSCMs>).
